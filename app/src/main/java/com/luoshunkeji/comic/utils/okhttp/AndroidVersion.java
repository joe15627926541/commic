 ...
 * on the device.
 * 
 * Code example on how to use AndroidVersion to load a multi-versioned class at
 * runtime for backwards compatibility without using reflection.
 * 
 * <pre class="code">
 * <code class="java">
...
public class AndroidVersion {
	...
	static {
		int android_sdk = 3; // 3 is Android 1.5 (Cupcake) which is the earliest
	...
	/** Returns true if running on Android 2.3.3 or lower. */
	...
	/** Returns true if running on Android 7.0 or higher. */
	public static boolean isNougatOrHigher() {
		return _ANDROID_SDK_VERSION >= Build.VERSION_CODES.N;
	}
