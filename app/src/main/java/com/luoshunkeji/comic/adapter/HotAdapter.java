...
public class HotAdapter extends BaseQuickAdapter<HomeEntity.DataBean, BaseViewHolder> {
    private Activity mActivity;
    private List<HomeEntity.DataBean> list;
    private final Handler handler = new Handler();

    public HotAdapter(Activity activity, int layoutResId, @Nullable List<HomeEntity.DataBean> data) {
